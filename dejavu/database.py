...
def get_database(database_type=None):
    ...
    try:
        importlib.import_module("dejavu.database_"+database_type)
        return Database.__subclasses__()[0]
    except ImportError:
        raise TypeError("Unsupported database type supplied: "+database_type)